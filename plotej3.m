...
title('prediccion de recompenzas futuras','fontsize',14);
xlabel('tiempo (ms)','fontsize',12);
...
title('diferencia de prediccion de recompenzas futuras','fontsize',14);
xlabel('tiempo (ms)','fontsize',12);
